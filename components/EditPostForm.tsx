...
export default function EditPostForm({ post }: { post: TPost }) {
  ...
  return (
    <div>
      <h2 className="flex">Edit Post<Image src="https://em-content.zobj.net/source/apple/354/pencil_270f-fe0f.png" className="ml-2 mb-1" width={25} height={10} alt="edit-post-img"/></h2>
